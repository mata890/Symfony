...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.my_firewall' => 'getSecurity_Firewall_Map_Context_MyFirewallService',
            'security.http_utils' => 'getSecurity_HttpUtilsService',
            'security.logout.success_handler.my_firewall' => 'getSecurity_Logout_SuccessHandler_MyFirewallService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'schoolmanager', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\SM\\LoginBundle\\Entity'))), 'SM\\LoginBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SMLoginBundle' => 'SM\\LoginBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7cf3811bf0e64f1c19d75a2f24bdfcf8bbe90419c9ba7d84a70a5def5982e5b1');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.demo_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'), 'security.firewall.map.context.my_firewall' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.my_firewall' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_MyFirewallService()
    {
        $a = $this->get('security.context');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        $c = $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        ...
        $g = $this->get('be_simple.sso_auth.factory');

        $h = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($d, array());
        $h->setOptions(array('login_path' => 'https://sso.univ-thies.sn:8443/cas/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $h->setProviderKey('my_firewall');

        $i = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array(), $b);
        $i->setOptions(array('login_path' => 'https://sso.univ-thies.sn:8443/cas/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $j = new \BeSimple\SsoAuthBundle\Security\Http\Firewall\TrustedSsoAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'my_firewall', $h, $i, array('manager' => 'admin_sso', 'login_action' => false, 'logout_action' => false, 'create_users' => true, 'created_users_roles' => array(0 => 'ROLE_USER'), 'check_path' => '/', 'use_forward' => false, 'require_previous_session' => true), $b, $c);
        $j->setFactory($g);

        return $this->services['security.firewall.map.context.my_firewall'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'my_firewall', $b, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57cd5d41649494.85291488', $b, $f), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'my_firewall', new \BeSimple\SsoAuthBundle\Security\Http\EntryPoint\TrustedSsoAuthenticationEntryPoint($e, $g, array('manager' => 'admin_sso', 'login_action' => false, 'logout_action' => false, 'create_users' => true, 'created_users_roles' => array(0 => 'ROLE_USER'), 'login_path' => 'https://sso.univ-thies.sn:8443/cas/login', 'check_path' => '/', 'remember_me' => true, 'use_forward' => false, 'require_previous_session' => true, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), NULL, NULL, $b));
    }

    /**
     * Gets the 'security.logout.success_handler.my_firewall' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BeSimple\SsoAuthBundle\Security\Http\Logout\SsoLogoutSuccessHandler A BeSimple\SsoAuthBundle\Security\Http\Logout\SsoLogoutSuccessHandler instance.
     */
    protected function getSecurity_Logout_SuccessHandler_MyFirewallService()
    {
        return $this->services['security.logout.success_handler.my_firewall'] = new \BeSimple\SsoAuthBundle\Security\Http\Logout\SsoLogoutSuccessHandler($this->get('http_kernel'), $this->get('be_simple.sso_auth.factory'), array('manager' => 'admin_sso', 'login_action' => false, 'logout_action' => false, 'create_users' => true, 'created_users_roles' => array(0 => 'ROLE_USER'), 'login_path' => 'https://sso.univ-thies.sn:8443/cas/login', 'check_path' => '/', 'remember_me' => true, 'use_forward' => false, 'require_previous_session' => true, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\SM\\InscriptionBundle/Resources/views'), 'SMInscription');
        $instance->addPath(($this->targetDirs[3].'\\src\\SM\\LoginBundle/Resources/views'), 'SMLogin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9755e0e60064a39d1d9aae78b2d5bf408225e5cb');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'demo_secured_area', $this->get('security.encoder_factory'), false), 1 => new \BeSimple\SsoAuthBundle\Security\Core\Authentication\Provider\SsoAuthenticationProvider($a, $b, true, array(0 => 'ROLE_USER'), false), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57cd5d41649494.85291488')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SMInscriptionBundle' => 'SM\\InscriptionBundle\\SMInscriptionBundle',
                'SMLoginBundle' => 'SM\\LoginBundle\\SMLoginBundle',
            ...
            'locale' => 'en',
            'secret' => '9755e0e60064a39d1d9aae78b2d5bf408225e5cb',
            ...
            'kernel.secret' => '9755e0e60064a39d1d9aae78b2d5bf408225e5cb',
            ...
            'be_simple.sso_auth.manager.admin_sso' => array(
                ...
                'server' => array(
                    'id' => 'cas',
                    'login_url' => 'https://sso.univ-thies.sn:8443/cas/login',
                    'logout_url' => 'https://sso.univ-thies.sn:8443/cas/logout',
                    'validation_url' => 'https://sso.univ-thies.sn:8443/cas/serviceValidate',
                ),
            ),
